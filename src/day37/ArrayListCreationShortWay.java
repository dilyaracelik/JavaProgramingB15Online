...
public class ArrayListCreationShortWay {
    public static void main(String[] args) {
        ...
        List<String> oop = List.of("Abstraction","Encapsulation","Inheritance", "Polymorphism_Muhtar") ;
        ...
        // or in one shot
        List<String> oopLst = new ArrayList<>( List.of("Abstraction","Encapsulation","Inheritance", "Polymorphism_Muhtar") ) ;
