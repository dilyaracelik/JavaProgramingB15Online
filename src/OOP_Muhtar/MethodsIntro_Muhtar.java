...
public class MethodsIntro_Muhtar {
...
//    Methods with parameters: sometime method needs specific information
//            (from the user) to perform its function
//    the argument that we are passing MUST match with parameter's data type
//            return statement: it's used for exiting the current method.  we can
//    also use return statement to return a vlaue from the method
}
