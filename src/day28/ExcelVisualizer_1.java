...
//to store this in one another array object.
int [][] sheet = new int [][] {  row1 , row2 , row3 , row4 , row5 , row6 }; //each item is 1 dimensional array

        System.out.println("-----------------------------------------");

int [][] myExcel = { {  10,27  } , {    87,99,100 }, { 90, 100}  }; //boyle de yapilabilir, 1 shot!!

        System.out.println(myExcel[1][2]); //100 bulur
        System.out.println(myExcel[2][0]);  // 90 bulur
 //how many item in this entire excel sheet --means how many row. (length)
 //in this 2D array object, we have 3 1D object stored.
        System.out.println(myExcel.length); //gives the array object count
// how many items do I have in 1st item of this 2D Array.
