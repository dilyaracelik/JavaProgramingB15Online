...
public class JobHunter {
    public static void main(String[] args) {
        ...
        myFavJobs.add(new Job("GA", 100000, "BOFA"));
        myFavJobs.add(new Job("VA", 90000, "Amazon"));
        myFavJobs.add(new Job("NY", 140000, "FaceBook"));
        myFavJobs.add(new Job("CA", 150000, "Apple"));
        myFavJobs.add(new Job("WA", 45000, "Microsoft"));
        ...
        Iterator<Job> jobList = myFavJobs.iterator();

        while(jobList.hasNext()){
            if (jobList.next().getSalary()<100000)
                jobList.remove();
        }
