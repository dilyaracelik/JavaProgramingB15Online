...
public class ArrayJobTitlePractice {
    public static void main(String[] args) {
        ...
        for (String eachOne : employees) {
            String jobTitle= eachOne.substring(eachOne.indexOf ("[")+1, eachOne.lastIndexOf("]"));
...
//        Ulrika-Goolding Nuclear Power Engineer
        ...
        for (String eachOne : employees){
            ...
            String all = eachOne.substring(0, eachOne.lastIndexOf("]")+1);
...
//Task 4:  //Print Initials -> Job Title for everyone
        ...
        for (String eachOne : employees) {
            ...
            String lastName = eachOne.substring(eachOne.indexOf(" ")+1);
            //  System.out.println(lastName.charAt(0));
            String jobTitle= eachOne.substring(eachOne.indexOf ("[")+1, eachOne.lastIndexOf("]"));
            System.out.println(""+ firstName.charAt(0) + lastName.charAt(0) + " -> " + jobTitle );
        }
...
//TASK 3:
        // Look for those 2 people in the array and assert below data
        /*
...
*/
////use for each to go throug each item and check
//        for (String eachOne: employees) {
//            String jobTitle= eachOne.substring(eachOne.indexOf ("[")+1, eachOne.lastIndexOf("]"));
//            String fullName = eachOne.substring(0, eachOne.indexOf("[")-1);
//            System.out.println(fullName);
//
//  if (fullName.equals("Tracy Bartle")){
//      if(jobTitle.equals("Geological Engineer"))
