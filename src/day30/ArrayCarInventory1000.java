...
public class ArrayCarInventory1000 {
    public static void main(String[] args) {
        ...
        String[] cars = {
                ...
                "Chrysler-Town & Country",
                "Chevrolet-Colorado"};
        // Task1 : count Chevrolet and civic //bu da olur
//        int chevyCNT = 0;
//        int civicCNT = 0;
//
...
//                        " Car Model is " + eachCarSplitted[1]);
        ...
        for (String eachCar : cars) {
            ...
            String[] eachCarSplitted = eachCar.split("-",2); //2'ye bol diyosun
        ...
        Arrays.sort(cars); //we can sort them
