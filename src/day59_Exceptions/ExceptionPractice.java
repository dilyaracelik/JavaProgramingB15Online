...
/*
if input is valid : no exception happens
we do not enter catch block.
If input is invalid : exception happens and
 exception object created => new StringIndexOutOfBoundException();
 the moment you have an exception java creates object that have all the information
 about this current situation(what kind of object..etc)
 Exception e : method parameter; how does it get the value  :somebody pass the value : Java
 Exception e = new StringIndexOutOfBoundException(); =>polymorphism
and enters catch block and handled
 */
