...
public class ArrayListPractice8_9 {
...
//ONE SHOT SOLUTION:
            for (String eachPro : productLst) {
                itemNames.add(eachPro.split(",")[0]);
                prices.add(Double.parseDouble(eachPro.split(",")[1]));
                monthlyPayments.add(Double.parseDouble(eachPro.split(",")[2]));
            }
