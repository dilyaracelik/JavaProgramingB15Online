...
public class SplitPracticeArrayList {
...
///Short ways to create
        System.out.println("item name = " + itemDetails.split(",")[0]);
        System.out.println("item price = " + Double.parseDouble(itemDetails.split(",")[1]));
        System.out.println("item monthly = " + Double.parseDouble(itemDetails.split(",")[2])); //double yapmaliyiz, price is double
