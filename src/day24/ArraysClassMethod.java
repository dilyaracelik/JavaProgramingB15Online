...
public class ArraysClassMethod {
    public static void main(String[] args) {
        ...
        System.out.println(superHerosAsString.charAt(0)); //1 yaparsak S cikar, cunku square braceti de icine aliyor
...
//ArraysToString her typeda kullanilir.
        int []numbers = {10,44,55,3,78};
        System.out.println(Arrays.toString(numbers));

double [] prices = {30.00, 40.00, 50.00};
