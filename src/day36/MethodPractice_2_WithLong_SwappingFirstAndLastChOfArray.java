...
public class MethodPractice_2_WithLong_SwappingFirstAndLastChOfArray {
    public static void main(String[] args) {
        ...
        long[] myNums1 = new long[5]; //primitive oldugu icin 0 verir
        System.out.println("myNums1 = " + Arrays.toString(myNums1));

        String[] names = new String[5];
        System.out.println("names = " + Arrays.toString(names));

        Long[] myNums2 = new Long[5]; //Object oldugu icin null verir
